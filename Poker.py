import random
# First Function for Input Players Names
def main ():
    players = []
    while True:
        player = (input("Enter the Name of Players (E TO EXIT): ")).upper()
        if player == "E":
            break
        players.append(player)
    Poker(players)
                        
#  Second Function Draw 2 Cards for Each Player       
def Poker (Nplayer):
...
# Shuffle the Deck and Make a Copy   
    random.shuffle(deck)
